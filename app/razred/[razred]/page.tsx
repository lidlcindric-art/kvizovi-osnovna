...
const razredInfo: Record<number, { naziv: string; opis: string; ikona: string; boja: string }> = {
  1: { naziv: '1. razred', opis: 'Matematika i Priroda i društvo', ikona: '🌱', boja: 'from-green-400 to-teal-500' },
  2: { naziv: '2. razred', opis: 'Matematika, Hrvatski jezik i Priroda i društvo', ikona: '📚', boja: 'from-blue-400 to-violet-500' },
    ...
    <main className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 p-6">
      <div className="max-w-2xl mx-auto pt-4">
        ...
        <div className={`bg-gradient-to-r ${info.boja} rounded-3xl p-8 mt-4 mb-8 text-white`}>
          ...
          <div className="mt-3 text-white/90 text-sm font-semibold">{teme.length} tema</div>
        </div>
